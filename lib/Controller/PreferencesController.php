...
/**
 * AppTemplate PreferencesController.
 *
 ...
 * @version GIT: <git_id>
 *
 * @link https://github.com/ConductionNL/nextcloud-app-template
 */
...
class PreferencesController extends Controller
{
    ...
    public function setPreference(string $key, string $value=''): JSONResponse
    {
        ...
        // An empty value clears the preference rather than storing '', so the
        // stored value reported back to the caller is null.
        if ($value === '') {
